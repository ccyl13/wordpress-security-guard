  ...
  return (
    <div className="result-card h-full overflow-hidden">
      <div className="card-header">
        <div className="flex items-center gap-2"><Cpu size={13} style={{ color: '#8b5cf6' }}/><span className="card-title">Informacion del sitio</span></div>
      ...
      <div className="px-4 py-2">
        <Row label="Version WordPress" value={info.version || 'Oculta'} good={!info.version}/>
        ...
        {info.sslInfo && <Row label="SSL / HTTPS" value={info.sslInfo.valid ? 'Valido' : 'Invalido'} good={info.sslInfo.valid}/>}
      </div>
    </div>
  );
}
